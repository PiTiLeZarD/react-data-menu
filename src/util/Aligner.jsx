...
export default class Aligner {
    align(target, alignTo, hints, handle) {
        ...
        if (alignTo) {
            ...
            (targetRect = RectUtil.getBoundingRect(target)), (viewportRect = ViewportUtil.getRect());

            targetHandle = handle ? RectUtil.getBoundingRect(handle) : RectUtil.cloneRect(targetRect);
